...
!                  ni=1为进行初始化，需要位势高度场做初值即可。
      ...
      open(11,file='C:\Users\48753\Desktop\NWP\02\data\practice\Input\za.dat')                   ! 输入的高度场（文本）
      open(12,file='C:\Users\48753\Desktop\NWP\02\data\practice\Input\ua.dat')								! 输入的u风场（文本）
      open(13,file='C:\Users\48753\Desktop\NWP\02\data\practice\Input\va.dat')                    ! 输入的v风场（文本）
					
      open(17,file='C:\Users\48753\Desktop\NWP\02\data\practice\Input\za.grd',form='binary') 		  ! 输入的高度场（二进制）	
      open(18,file='C:\Users\48753\Desktop\NWP\02\data\practice\Input\ua.grd',form='binary') 		  ! 输入的u风场（二进制）				
      open(19,file='C:\Users\48753\Desktop\NWP\02\data\practice\Input\va.grd',form='binary') 		  ! 输入的v风场（二进制）				
			    	
      open(21,file='C:\Users\48753\Desktop\NWP\02\data\practice\Output\rm.dat')                   ! 地图放大系数
      open(22,file='C:\Users\48753\Desktop\NWP\02\data\practice\Output\f.dat')                    ! 地转参数
					
      open(23,file='C:\Users\48753\Desktop\NWP\02\data\practice\Output\ub.dat')                   ! 静力初始化得到的u风场（文本）
        open(24,file='C:\Users\48753\Desktop\NWP\02\data\practice\Output\ub.grd',form='binary')     ! 静力初始化得到的u风场（二进制）
      open(25,file='C:\Users\48753\Desktop\NWP\02\data\practice\Output\vb.dat')                   ! 静力初始化得到的v风场（文本）
        open(26,file='C:\Users\48753\Desktop\NWP\02\data\practice\Output\vb.grd',form='binary')     ! 静力初始化得到的v风场（二进制）

      open(27,file='C:\Users\48753\Desktop\NWP\02\data\practice\Output\zc.dat')                   ! 预报的高度场（文本）
			open(28,file='C:\Users\48753\Desktop\NWP\02\data\practice\Output\zc.grd',form='binary')     ! 预报的高度场（二进制）
			open(29,file='C:\Users\48753\Desktop\NWP\02\data\practice\Output\uc.dat')                   ! 预报的u风场（文本）
			open(30,file='C:\Users\48753\Desktop\NWP\02\data\practice\Output\uc.grd',form='binary')     ! 预报的u风场（二进制）
			open(31,file='C:\Users\48753\Desktop\NWP\02\data\practice\Output\vc.dat')                   ! 预报的v风场（文本）
			open(32,file='C:\Users\48753\Desktop\NWP\02\data\practice\Output\vc.grd',form='binary')     ! 预报的v风场（二进制）
...
!  计算放大系数和地转参数,并写入数据文件中
      ...
      write(22,'(20e15.5)')f
			...
			write(*,*)
			write(*,*)'请输入数字0或1后按回车运行，0表示不进行静力初始化；1表示进行静力初始化。'
			write(*,*)
			write(*,*)'注意：如果求地转风的子程序（风场初始化）未完成，则只能输入数字0。'
			read(*,*)ni
            write(*,*)'请输入数字1或2后按回车运行，l=1为只执行正平滑，l=2为执行正逆平滑'
            read(*,*)l
